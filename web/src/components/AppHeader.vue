<template>
  <header class="flex justify-between items-center p-4 bg-white shadow w-full z-10 mb-1">
    <div class="flex items-center space-x-4">
      ...
      <a class="flex items-center" target="_blank" href="about blank">
        <img src="/icon.svg" alt="MarkdownDocx Logo" class="h-8 w-8 mr-4" />
        <div class="text-xl font-bold text-indigo-600">AI 2 Docx</div>
      </a>
...
<!--
    ...
    -->
      ...
      >
        ...
        <span class="hidden sm:inline-block ml-2 font-semibold">Copyright</span>
      </a>
    -->
    </div>
  </header>
